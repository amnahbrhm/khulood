...
export class MainComponent {
  ...
  images: any[] = [
    ...
    },
    {
      ...
      subtitle: ['اهداف',' برنــــــــامــــج','صعوبات التعلم'],
      number: '01',
      count: 120
    },
    {
    ...
    },
    {
      ...
      indexColor: '#818255',
      title: 'اوراق العمل ',
      // subtitle: 'نماذج من اوراق العمل',
      subtitle: ['نماذج ','من اوراق ','العـــــــــــمــل'],
      number: '06',
      count: 120
    },
    {
  ...
  openContent(numberOfImage: string){
    ...
    if(numberOfImage === '05') this.router.navigate(['schoolxteacher'])
